...
* A :ref:`cold minting script <cold_minting_script>`.
* A :ref:`hot minting script <hot_minting_script>`.
...
To do this, they require only that an NFT minted by the corresponding minting script is spent by the transaction. 
...
.. warning::
   ...
   To mitigate the risks involved, it is imperative to follow these guidelines, none of which are enforced by the system:
